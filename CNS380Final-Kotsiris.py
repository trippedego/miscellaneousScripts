...
def malware():
    ...
    dir = 'C:\\Users\\student\\files\\' # Where ever you put the malicious files on your host.
    while True:
            ...
            for filename in files:
                ...
                if filename not in baseline:
                    try:
                        ...
                        total = res.get("total")
                        print('{} has {} positive hits out of {}...'.format(filename,positives,total))
                        try:
                        ...
                        if percentage > 5 or positives > 4:
                            print("\t{} is the malicious file.".format(filename))
                    except:
                        continue
